  ...
  return (
    <div className="p-5 bg-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        ...
        <Link to="/merge-sort" className="min-w-[300px] min-h-[30px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s5.png)', backgroundSize: 'cover' }}>
