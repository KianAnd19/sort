  ...
  return (
    <div className="p-5 bg-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-10">
        <Link to="/selection-sort" className="min-w-[200px] min-h-[200px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s1.png)', backgroundSize: 'cover' }}>
        ...
        <Link to="/bucket-sort" className="min-w-[200px] min-h-[200px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s8.png)', backgroundSize: 'cover' }}>
          <div className="text-xl font-medium text-black bg-slate-50 rounded-sm px-1 shadow-xl">Bucket Sort</div>
        </Link>
        <Link to="/shell-sort" className="min-w-[200px] min-h-[200px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s9.png)', backgroundSize: 'cover' }}>
          <div className="text-xl font-medium text-black bg-slate-50 rounded-sm px-1 shadow-xl">Shell Sort</div>
        </Link> 
        <Link to="/counting-sort" className="min-w-[200px] min-h-[200px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s10.png)', backgroundSize: 'cover' }}>
          <div className="text-xl font-medium text-black bg-slate-50 rounded-sm px-1 shadow-xl">Counting Sort</div>
        </Link>
        <Link to="/random-sort" className="min-w-[200px] min-h-[200px] p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex justify-center items-center space-x-4 hover:bg-gray-100" style={{ backgroundImage: 'url(/sort/s11.png)', backgroundSize: 'cover' }}>
